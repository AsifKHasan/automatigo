INSERT INTO cmn.office_unit_category(oid, name_en, name_bn, sort_order, is_deleted, created_by, created_on, updated_by, updated_on)
SELECT oid, name_en, name_bn, sort_order, is_deleted, created_by, created_on, updated_by, updated_on
FROM dblink('dbname=grp_bcc_live',
'SELECT oid, name_en, name_bn, sort_order, is_deleted, created_by, created_on, updated_by, updated_on
FROM cmn.office_unit_category')
