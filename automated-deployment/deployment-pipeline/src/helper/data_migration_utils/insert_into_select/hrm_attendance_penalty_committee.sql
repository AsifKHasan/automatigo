INSERT INTO hrm.attendance_penalty_committee(oid, committee_oid, committee_name, short_description, member_oid, member_name_en, member_name_bn, designation_en, designation_bn, role)
...
'SELECT oid, committee_oid, committee_name, short_description, member_oid, member_name_en, member_name_bn, designation_en, designation_bn, role
FROM hrm.attendance_penalty_committee')
